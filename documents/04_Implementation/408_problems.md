...
Another issue that came along while testing, is that Prometheus uses the Private IP of the servers to work, and my inventory only counted with the Public IPs, so it was not able to communicate with the target servers and showed them offline.
